...
/**
 * Test all the method from the MultiPyramidSolitaire.
 */
public class MultiPyramidSolitaireTest {
  ...
  public void testGetRowWdith() {
    Assert.assertEquals(7, model.getRowWidth(0));
  }
  ...
  public void testGetCardAtWithNum() {
    Assert.assertEquals("3♣", model.getCardAt(6, 3).toString());
  }

  @Test
  public void testGetScoreWithCard() {
    Assert.assertEquals(442, model.getScore());
  }
